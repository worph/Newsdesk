...
--> statement-breakpoint
CREATE UNIQUE INDEX `publications_story_target_idx` ON `publications` (`story_id`,`target_id`);--> statement-breakpoint
...
CREATE INDEX `submissions_source_idx` ON `submissions` (`source_id`);--> statement-breakpoint
